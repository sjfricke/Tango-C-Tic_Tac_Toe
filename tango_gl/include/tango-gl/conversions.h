...
#ifndef TANGO_GL_CONVERSIONS_H_
#define TANGO_GL_CONVERSIONS_H_
...
/**
 * @brief Creates a glm::mat4 rigid-frame transformation matrix from glm::vec3
 * and glm::quat.
 * This is designed for the TangoPoseData translation and orientation fields.
 ...
 * @return The transformation matrix A_T_B.
 */
inline glm::mat4 TransformFromVecAndQuat(const glm::vec3& A_p_B,
